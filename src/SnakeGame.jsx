...
export default function SnakeGame() {
  ...
  const miamSoud = new Audio("/miam.mp3");
  const gameStart = new Audio("/game.mp3");
  ...
  return (
    <div className="board">
      ...
      <p id="credit">
        by Quentin Ribardière <br />{" "}
        <a href="https://github.com/Quentinrbd/snake-game" target="_blank">
          Github repo
        </a>
      </p>
    </div>
